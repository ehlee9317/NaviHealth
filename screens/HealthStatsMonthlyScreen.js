...
export default function MonthlyHealthStatsScreen() {
  ...
  // sets beginning date to 30 days ago for pulling firebase data:
  ...
  useEffect(() => {
    const unsubscribe = db
      ...
      .onSnapshot((querySnapshot) => {
        ...
        // convert data into victory chart data format:
